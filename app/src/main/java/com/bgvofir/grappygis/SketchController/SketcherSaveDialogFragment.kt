...
class SketcherSaveDialogFragment(context: Context, mMapView: MapView): Dialog(context), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.bgvofir.grappygis.R.layout.fragment_dialog_sketcher_save_input)
    ...
    fun setGeometry(){
        ...
        FeatureLayerController.addGeometryToMap(geometry, mMapView, "קו מגניב", type)
    }
